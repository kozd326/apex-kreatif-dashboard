  ...
  const handleSaveLead = async (savedLead: Lead) => {
    ...
    if (editingLead) {
      ...
      const { error } = await supabase.from('leads').update({
        ...
        audit_sources: savedLead.audit_sources,
        website_findings: savedLead.website_findings,
        social_findings: savedLead.social_findings,
        booking_findings: savedLead.booking_findings,
        brand_findings: savedLead.brand_findings,
        audit_checked_at: savedLead.audit_checked_at,
        call_opening: savedLead.call_opening,
        discovery_questions: savedLead.discovery_questions,
        objection_reply: savedLead.objection_reply,
        next_best_action: savedLead.next_best_action,
