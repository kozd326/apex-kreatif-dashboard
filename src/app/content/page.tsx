...
const FORMATS: ContentFormat[] = ['Reels', 'Post', 'Story', 'Carousel', 'Case Study'];
const PILLARS = ['Ajans Tanıtımı', 'Hizmet Anlatımı', 'Mini Denetim', 'İş Süreci', 'Portföy / Sonuç', 'Eğitici İçerik'];

const blankDraft = () => ({ title: '', format: 'Reels' as ContentFormat, pillar: 'Ajans Tanıtımı', objective: '', hook: '', script: '', production_notes: '', caption: '', planned_for: '' });
